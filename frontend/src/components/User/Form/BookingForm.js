  ...
  return (
    <div>
      {bookingConfirmed ? (
        <div >
          <section className="bookSuccess">
            <div className="container"  >
              <div className="row">
                <div className="col-md-12 text-center" style={{ marginTop: 100 }}>
                <h1 >Đặt phòng thành công!</h1>
                <p>Thông tin đặt phòng đã được gửi.</p>
                <a href="/booking/history">Nhấn vào đây để xem những phòng bạn đã đặt</a>
                </div>
              </div>
            </div>
          </section>
        ...
        <>
          <section className="bg-light p-3 p-md-4">
                          ...
                          <div className="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <form action="#!">
                              <div className="row gy-3 overflow-hidden">
                                ...
                                <div className="col-12">
                                    {errorMessage && renderErrorMessage()} {/* Hiển thị thông báo lỗi */}
                                </div>
                              </div>
                            </form>
                          </div>
